                                                              ...
                                                              child: TextFormField(
                                                                  ...
                                                                  decoration: InputDecoration(
                                                                      hintText:
                                                                          "lbl_nike_air_max"
                                                                              .tr,
                                                                      hintStyle: AppStyle.textstylepoppinsbold122.copyWith(
                                                                      ...
                                                                      disabledBorder: OutlineInputBorder(borderRadius: BorderRadius.circular(getHorizontalSize(5.00)), borderSide: BorderSide(color: ColorConstant.lightBlueA200, width: 1)),
                                                                      ...
                                                                      suffixIcon: Container(padding: EdgeInsets.only(left: getHorizontalSize(10.00), right: getHorizontalSize(16.00)), child: Container(height: getSize(20.00), width: getSize(20.00), child: SvgPicture.asset(ImageConstant.imgClearIcon, fit: BoxFit.fill))),
